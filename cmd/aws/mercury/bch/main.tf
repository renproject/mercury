...
variable "bch_mainnet_username" {
  description = "jsonrpc username for bitcoin cash mainnet nodes"
}

variable "bch_mainnet_password" {
  description = "jsonrpc password for bitcoin cash mainnet nodes"
}

variable "bch_testnet_username" {
  description = "username for bitcoin cash testnet nodes jsonrpc"
}

variable "bch_testnet_password" {
  description = "password for bitcoin cash tesnet nodes jsonrpc"
}
